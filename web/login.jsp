<!-- Ο ΧΡΗΣΤΗΣ ΘΑ ΣΥΝΔΕΘΕΙ ΜΕΣΩ ΤΟΥ index.jsp ΕΦΟΣΟΝ ΠΑΤΗΣΕ ΤΗΝ ΕΠΙΛΟΓΗ ΤΟΥ ΚΑΦΕ--><%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<form method="post" action="Login"> <!-- Η ΦΟΡΜΑ ΘΑ ΚΑΝΕΙ ΤΟ ΤΑΙΡΙΑΣΜΑ ΜΕ ΤΟ ΑΡΧΕΙΟ Login.java 
    ΩΣΤΕ ΝΑ ΕΛΕΓΧΘΕΙ ΓΙΑ ΤΟ ΑΝ ΘΑ ΓΙΝΕΙ ΣΩΣΤO LOGIN-->        
    <section id="contact">
        <div class="container">
